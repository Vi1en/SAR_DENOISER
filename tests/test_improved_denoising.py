...
def test_parameter_configurations():
    ...
    print("📊 Check assets/images/denoising_comparison.png for visual results")
...
def create_comparison_plot(clean, noisy, results):
    ...
    plt.tight_layout()
    plt.savefig(paths.ensure_assets_images() / "denoising_comparison.png", dpi=150, bbox_inches="tight")
    plt.close()
    
    print("📊 Comparison plot saved: assets/images/denoising_comparison.png")
