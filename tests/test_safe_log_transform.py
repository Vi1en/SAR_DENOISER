...
def test_safe_log_transform():
    ...
    print("📊 Check assets/images/safe_log_transform_comparison.png for visual results")
...
def create_safe_comparison_plot(clean, noisy, results):
    ...
    plt.tight_layout()
    plt.savefig(paths.ensure_assets_images() / "safe_log_transform_comparison.png", dpi=150, bbox_inches="tight")
    plt.close()
    
    print("📊 Safe comparison plot saved: assets/images/safe_log_transform_comparison.png")
