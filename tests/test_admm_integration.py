...
def test_admm_integration():
    ...
    plt.tight_layout()
    plt.savefig(paths.ensure_assets_images() / "admm_integration_results.png", dpi=150, bbox_inches="tight")
    plt.close()
    
    print("✅ ADMM integration test completed!")
    print("📁 Results saved to: assets/images/admm_integration_results.png")
