...
def create_visualization_example():
    ...
    plt.tight_layout()
    plt.savefig(paths.ensure_assets_images() / "bulletproof_display_example.png", dpi=150, bbox_inches="tight")
    plt.close()
    
    print("📊 Comprehensive visualization saved: assets/images/bulletproof_display_example.png")
