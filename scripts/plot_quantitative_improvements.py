...
_FIG_DIR = paths.ensure_assets_images()
...
plt.savefig(_FIG_DIR / "quantitative_improvements.png", dpi=300, bbox_inches="tight")
print("✅ Generated assets/images/quantitative_improvements.png")
plt.close()
...
plt.savefig(_FIG_DIR / "quantitative_improvements_simple.png", dpi=300, bbox_inches="tight")
print("✅ Generated assets/images/quantitative_improvements_simple.png")
plt.close()

print("\n📊 Visualization complete!")
print("   - assets/images/quantitative_improvements.png (comprehensive 6-panel view)")
print("   - assets/images/quantitative_improvements_simple.png (simplified 2-panel view)")
