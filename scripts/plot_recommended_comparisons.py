...
def plot_psnr_comparison():
    ...
    plt.tight_layout()
    plt.savefig(_FIG_DIR / "psnr_comparison.png", bbox_inches="tight", facecolor="white")
...
def plot_ssim_comparison():
    ...
    plt.tight_layout()
    plt.savefig(_FIG_DIR / "ssim_comparison.png", bbox_inches="tight", facecolor="white")
...
def plot_difference_map():
    ...
    plt.savefig(_FIG_DIR / "difference_map_comparison.png", bbox_inches="tight", facecolor="white")
...
def plot_runtime_comparison():
    ...
    plt.tight_layout()
    plt.savefig(_FIG_DIR / "runtime_comparison.png", bbox_inches="tight", facecolor="white")
...
def plot_edge_preservation():
    ...
    plt.tight_layout()
    plt.savefig(_FIG_DIR / "edge_preservation_comparison.png", bbox_inches="tight", facecolor="white")
